...
<html>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
		...
		<title>Asignacion Pedidos Chofer</title>
	 			...
	 			<div class="containerPrincipal" > 
		 			<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
	 					<div class="navbar-header"> 
							<table height="45px" >
							    <tr align="center">
								    <td valign="middle" align="right"> <label class="TextosGrande" style="color: white;">  &nbsp;&nbsp; Centro de Distribuci&oacute;n Oriente S.A de C.V </label></td>
							    </tr>
							</table>	
						</div> 
		 			</nav>
	 		...
	 		<div id="DivLoguin" style="margin-top: 20px;" class="col-md-3 col-md-offset-4 col-sm-3 col-sm-offset-4 " > 
					...
					<div class="panel panel-primary">
					 	<div class="panel-heading">
                             <div class="panel-title" align="left"> <label class="lbTexto">Sistema Asignacion Pedidos Chofer</label></div>
                        </div>
								...
								<tr>
									<td colspan="2" align="center">
										<div>
											...
											<input type="hidden" name="proceso_web" id="idIndex" value="68" >
