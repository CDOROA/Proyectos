...
<script type="text/javascript"
	...
	<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/JS-Contacto.js"></script>
			<script type="text/javascript">
function bigImg(id) {
...
<body>
	...
	<div class="container-fluid" style="padding-top: 25px">
		<div class="row">
			<div class="col-12">
				<label class="h1 EtiquetaUnderLine">CONTACTO</label><br>
			</div>
		</div>

		<div class="row">
			<div class="col-lg-3  col-md-12 col-sm-12">
				<div id="btncontCorrDist" class="hovereffect-D" data-toggle="modal" data-target="#modalContDist">
					<img class="img-fluid"
						src="${pageContext.request.contextPath}/img/contacto/contactoCorreo.png"
						alt="" style="display: inline-block; padding: 10px; width: 285px"></img>
			...
			<div class="col-lg-3  col-md-12 col-sm-12">
				<a href="https://wa.me/message/GFGEO5Z4CB73B1" target="_blank">
					<div class="hovereffect-D">
						<img class="img-fluid"
							src="${pageContext.request.contextPath}/img/contacto/contactoWhatsApp.png"
							alt="" style="display: inline-block; padding: 10px; width: 285px"></img>
						<div class="overlay"></div>
					</div>
				</a>
			...
			<div class="col-lg-3  col-md-12 col-sm-12">
				<a href="https://t.me/OEP_Autopartes" target="_blank">
					<div class="hovereffect-D">
						<img class="img-fluid"
							src="${pageContext.request.contextPath}/img/contacto/contactoTelegram.png"
							alt="" style="display: inline-block; padding: 10px; width: 285px"></img>
						<div class="overlay"></div>
					</div>
				</a>
			...
			<div class="col-lg-3  col-md-12 col-sm-12">
				<div id="btncontCorrSPT" class="hovereffect-D" data-toggle="modal"
					data-target="#modalContDist">
					<img class="img-fluid"
						src="${pageContext.request.contextPath}/img/contacto/coCorreoSoporte.png"
						alt="" style="display: inline-block; padding: 10px; width: 285px"></img>
					<div class="overlay"></div>
				</div>
			</div>
		...
		<div id="modalContDist" class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel1" aria-hidden="true">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="col-12">
							...
							<div class="form-group form-group-lg">
								<div class="col-12">
									<label class="control-label pull-right"
										for="txt_nombre_contacto"
										style="color: black; margin-bottom: 0px;"><spam
											style="font-weight: bold;color: #ed2525;">*</spam>Nombre</label>
								</div>
								<div class="col-12">
									<input class="form-control" type="text"
										id="txt_nombre_contacto">
								</div>
							</div>
							...
							<div class="form-group form-group-lg">
								...
								<div class="col-12">
									<input class="form-control" type="text"
										id="txt_correo_contacto">
								</div>
							</div>
							<div class="form-group form-group-lg">
								<div class="col-12">
									<label class="control-label pull-right"
										for="txt_whatsApp_contacto"
										style="color: black; margin-bottom: 0px;"><spam
					...
					<div class="modal-footer">
						...
						<button id="Btn_cancelarQuieroSerDist" type="button"
						...
						<div class="form-group form-group-lg" style="margin-bottom: 0px;">
							...
							<button type="button" class="btn btn-danger"
								style="background-color: #CC303B;" id="Btn_enviarQuieroSerDist">Enviar</button>
