...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/jsClientesOEP.js"></script>
...
// 	 	var results2 = JSON.parse(results)
	...
	function setMarkers(map, latitud, longitud) {
		...
		if(kmTotal < distanciaRecorr || kmTotal == ""){
			...
			var image = {
				url : "https://www.oep.com.mx/img/headerFooter/Logotipo_OEP.png",
...
// 		  "<br>Longitude: " + position.coords.longitude;
	...
	<div id="DivAceites"
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12"
				...
				<table width="98%" style="margin-top:1%">
					<tr>
						<td style="text-align:center;">
							<h2 style="font-style: bold;" class="pull-right">¿DÓNDE
								COMPRAR?</h2>
						</td>	
						<td  style="text-align:center;" >
							<h5>
							...
							<td>
							<h5>
								<i class="bi bi-asterisk"></i> Puntos de
								Venta
							</h4>
						</td>
					</tr>
	...
	<div class="row" style="padding-left: 20px;">
		<div class="col-md-4 col-sm-12" style="font-size:12px;">
			<div style="margin-top: 10px; display: none" class="input-group2" id="msjInicio">			
				<span class="input-group-addon2" style="width: 100%; margin-left:10%"><h6><b> Se mostrarán las refaccionarias que se encuentran <br> a 5 km de su ubicación. </b></h6></span> 
			</div>
			<div style="margin-top: 10px;" class="input-group2">			
				<span class="input-group-addon2" style="width: 100%; margin-left:10%; font-size:12px;"><b>------------ Ingrese los siguientes datos para la búsqueda ------------<br>------------de sus refaccionarias más cercanas. ------------</b></span> 
			</div>
			<div style="margin-top: 10px;" class="input-group">			
				<span class="input-group-addon" style="width: 49%"> CODIGO POSTAL </span> 
					...
					<input type="text" id="cp" name="cp" class="form-control" maxlength="5" style="width: 100%; height:2%;"/>
			</div>
			<div style="margin-top: 10px" class="input-group">
...
<!-- 						</c:forEach> -->
<!-- 					</select>   -->
					<select name="pais" id="pais" class="form-control" style="width: 100%; height:2%;"> 
			...
			<div style="margin-top: 10px" class="input-group">
				...
				<select name="km" id="km" class="form-control" style="width: 100%; height:2%;"> 
			...
			<div style="margin-top: 10px" class="input-group">
				<span class="input-group-addon" style="width: 100%; height:2%;"> PRODUCTO </span> <select
					name="cmbproductos" id="cmbProductos" class="form-control" style="width: 107.2%">
					<option value="0">TODOS LOS PRODUCTOS</option>
					<c:forEach var="articulo" items="${lisArticulos}">
						<option value="${articulo.cve_producto_oep}">${articulo.descripcion}</option>
					</c:forEach>
				</select>
			</div>
			...
			<div style="margin-top: 10px" class="input-group pull-right">
				<table width="100%"> 
					<tr>
					<td width="18%"><label style="color: white">___</label></td>
					<td width="18%">
						   <button class="btn btn-success" type="button" id="limpiar" onclick="limpiar()"><i class="bi bi-file-earmark-x"></i></i> Limpiar</button>
						</td>
						<td width="1%"><label style="color: white">___</label></td>
						<td width="31%">
						   <button class="btn btn-success" type="button" id="obtenerUbicacion" onclick="localizador()"><i class="bi bi-globe-americas"></i> Obtener Ubicacion</button>
						</td>
						<td width="1%"><label style="color: white">___</label></td>
						<td>
							<button class="btn btn-warning pull-right" type="button"
								onclick="ConsultaClienteKwx()">
								<i class="bi bi-search"></i></i>Buscar
							</button>
						</td>
					</tr>
				</table>
...
<%-- 											${cliente.km}</p> --%>
										<button id="img-0" type="button"
											...
											style="margin-right: 12px; margin-left: 12px;"></button>
