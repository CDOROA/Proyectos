...
<body>
	...
	<div class="container-fluid" style="padding-top: 25px">
		<div class="row">
			<div class="col-12">
				<label class="h1 EtiquetaUnderLine">COMPRA EN LÍNEA</label> 
			</div>
		</div>
			<div class="col-12">
			<div class="align-self-baseline">			
				 <img src="${pageContext.request.contextPath}/img/compraEnLinea/CompraEnlinea.png" style="max-width:100px; margin-bottom: 32px;" > 
				</div>
			</div>
		<div class="row">
			<div class="col-lg-6  col-md-12 col-sm-12">
				<a href="https://www.autorep.mx/" target="_blank">
					<div class="hovereffect-D">
						<img class="img-fluid"
							src="${pageContext.request.contextPath}/img/compraEnLinea/btnAutoRep.png"
							alt=""
							style="display: inline-block; padding: 10px; width: 485px"></img>
						<div class="overlay"></div>
						<br> <label class="h1 Etiqueta mr-auto" style="color:#000000; margin-top: 8px;">Auto-Rep  Refacciones</label>
					</div>
				</a>
			...
			<div class="col-lg-6  col-md-12 col-sm-12">
				<a href="https://cutt.ly/jcFbB4L" target="_blank">
					<div class="hovereffect-D">

						<img class="img-fluid"
							src="${pageContext.request.contextPath}/img/compraEnLinea/btnMercadoLibre.png"
							alt=""
							style="display: inline-block; padding: 10px; width: 485px"></img>
						<div class="overlay"></div>
						<br><label class="h1 Etiqueta mr-auto" style="color:#000000; margin-top: 8px;">Tienda Oficial Mercado Libre</label> 
					</div>
				</a>
