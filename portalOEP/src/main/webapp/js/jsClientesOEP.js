            										...
            										var clin = clientes[i].km.replace(" ","")
         								    	   	if(Number(kmL) == Number(clin)){
     													...
     													'<td style="text-align:center;">' +
     														...
     														'<button type="button" style="background-color:black; margin-bottom:3px;"><label style="color:white;">KM: ' +
     													...
     													'</td>' +
     												'</tr>'+
     												'<td><hr style="color: black; background-color: black; width:100%;" /></td>';
			  ...
			  var contenido = '<div id="content" style="width:100%;" align="center">' +
									...
									if(km != ''){	
										var kms = '<tr>'+
											...
											'<i class="bi bi-geo-alt-fill"></i>  <a href="https://www.google.com/maps/place/'+coordenada+'/@'+latitud+''+longitud+'" target="_blank" style="color:#00bfd9" >Ver en Google maps</a>'+
											'</td>'+
											'</tr>'+
