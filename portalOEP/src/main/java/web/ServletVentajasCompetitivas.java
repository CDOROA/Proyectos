...
public class ServletVentajasCompetitivas extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public ServletVentajasCompetitivas() {
        super();
    }
	...
	//		consultaQuerys();
		try
		{
			...
			{
				case 1:
						RedirecionaVista("VentajasCompetitivas.jsp", request, response);			
				break;
		...
		{
			String sError= ex.getMessage().toString();
			System.out.println("[ Portal OEP ] error en ServletVentajasCompetitivas.ValidaPeticion = " + ex);
		}
