...
{
	var imagenes = $("#txtImagenInicialPagPrincipal").val(); 
	var split = imagenes.split(",");
	$("#divMensajeInicio").show()
	$("#pruebaCarrusel").empty()
	var contenido = "  " +
	"<div id='carouselExampleIndicators' class='carousel  slide-fade' data-ride='carousel'>"+ 
		"<ol class='carousel-indicators'>";
			...
			{
			  var imgSplit = split[i].split("*"); 
			  if (imgSplit[1] == 1) 
			  {
				contenido += aux == 0 ? "<li data-target='#carouselExampleIndicators' data-slide-to='0' class='active'></li>" : "<li data-target='#carouselExampleIndicators' data-slide-to='"+aux+"'></li>";
				aux++;
			  }
			}
		contenido += "</ol>"+
			...
			for (var i = 0; i < split.length; i++) 
			{
			  ...
			  if (imgSplit[1] == 1) 
			  {
				  contenido += aux == 0 ? 
						  ...
						  "<img class='d-block ' style='width: 90%;'src='https://www.cdoautopartes.com.mx/image/boletines/"+imgSplit[0]+"' alt='First slide'>"+
						  "</div>" : 
							  "<div class='carousel-item'>"+
							  "<img class='d-block ' style='width: 90%;'src='https://www.cdoautopartes.com.mx/image/boletines/"+imgSplit[0]+"' alt='Second slide'>"+
							  "</div>";
				 aux++;
			  }
			}
	...
	$("#popupMensajeInicio").show()	
	$("#pruebaCarrusel").append(contenido) 
	$('.carousel').carousel()
