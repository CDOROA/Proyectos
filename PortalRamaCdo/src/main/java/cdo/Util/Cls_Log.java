...
public class Cls_Log 
{
	...
	private static void insertaSentenciaLogDeCarritoEnBD(Log log)
	{
		...
		try
		{
		 	  System.out.println("Accion.-  " + log.getAccion());
		...
		{
			System.out.println("NuevoportalRamaCDO.- Error al insertar Log.insertaSentenciaLogDeCarritoEnBD. Detalle del Error: " + ex.getMessage().toString() );
		}
		finally
		{
