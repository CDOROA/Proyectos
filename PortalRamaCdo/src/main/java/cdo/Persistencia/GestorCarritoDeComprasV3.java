...
import cdo.Datos.RamComparator;
...
public class GestorCarritoDeComprasV3  extends HttpServlet 
{
...
//			System.out.println("****** LISTA *****: "+listaArticulos);

		}
		catch(Exception  ex)
		{
			// System.out.println("[NuevoportalRamaCDO.- Error: Consulta general de articulos consultaGeneralArticulos(),  Clase: GestorCarritoDeComprasv3.consultaGeneralArticulos,  Detalle: " + ex.toString() +"]");
			Log log=new Log(1,infoCliente.getCve_cdo(),infoCliente.getCve_cliente() ,0, "[Error: Consulta general de articulos,  Clase: GestorCarritoDeComprasv3.consultaGeneralArticulos,  Detalle: " + ex.getMessage().toString() +"]");
			Cls_Log.insertaLog(log);
	...
	{	
		...
		catch(Exception  ex)
		{
			...
			// System.out.println("[NuevoportalRamaCDO.- Error: Consulta  de articulos por marca de calidad,  Clase: GestorCarritoDeComprasV3.consultaArtNuevos,  Detalle: " + ex.getMessage().toString() +"]");
			Log log=new Log(01,infoCliente.getCve_cdo(),infoCliente.getCve_cliente() ,0, "[Error: Consulta  de articulos por marca de calidad,  Clase: GestorCarritoDeComprasV3.consultaArtNuevos,  Detalle: " + ex.getMessage().toString() +"]");
			Cls_Log.insertaLog(log);
		}
		return listaArticulos;
	}
...
//             System.out.println("Query primero: " + query);
		...
		{
			//System.out.println("[NuevoportalRamaCDO.- Error: Consultar articulos por parametro en Solr APLICACION,  Clase: GestorCarritoDeComprasV3.qryConsultaGeneralAticulosEnSolrAPLICACION,  Detalle: " + ex.getMessage().toString() +"]");
			Log log=new Log(01,infoCliente.getCve_cdo(),infoCliente.getCve_cliente() ,0, "[NuevoportalRamaCDO.- Error: Consultar articulos por parametro en Solr APLICACION,  Clase: GestorCarritoDeComprasV3.qryConsultaGeneralAticulosEnSolrAPLICACION,  Detalle: " + ex.getMessage().toString() +"]");
			Cls_Log.insertaLog(log);
		...
		try
		{
			...
			for (int i=0; i <  lista.size(); i++) 
			{
				...
				if(lista.get(i).replace("-", "").trim().length() > 0)
				{
					...
					sentencia +=   "(num_art_cdo:" + lista.get(i).replace("-", "").replace("[", "").replace("]", "")+"*" + 
							   " OR num_art_prov:" + lista.get(i).replace("-", "").replace("[", "").replace("]", "") +"*" +
							   " OR num_art_cdo_sin_guion:" + lista.get(i).replace("-", "").replace("[", "").replace("]", "") +"*" +
							   " OR num_art_prov_sin_guion:" + lista.get(i).replace("-", "").replace("[", "").replace("]", "") +"*" +
							   " OR num_art_anterior_sin_guion:" + lista.get(i).replace("-", "").replace("[", "").replace("]", "") +"*" +
							   " OR intercambios:*" + lista.get(i).replace("-", "").replace("[", "").replace("]", "") +"*" +
							   " OR intercambios_sin_guion:*" + lista.get(i).replace("-", "").replace("[", "").replace("]", "") +"*" +
							   " OR proveedor:*" + lista.get(i).replace("-", "").replace("[", "").replace("]", "") +"*" +
							   " OR marca:" + lista.get(i).replace("-", "").replace("[", "").replace("]", "") +"*" +
							   " OR descripcion:" + lista.get(i).replace("-", "").replace("[", "").replace("]", "") +"*" +
							   " OR armadora:" + lista.get(i).replace("-", "").replace("[", "").replace("]", "") +"*" +
							   " OR modelo:" + lista.get(i).replace("-", "").replace("[", "").replace("]", "") +"*" +
							   " OR grupo:" + lista.get(i).replace("-", "").replace("[", "").replace("]", "") +"*" +
							   " OR submodelo:" + lista.get(i).replace("-", "").replace("[", "").replace("]", "") +"*" +
							   " OR num_original:*" + lista.get(i).replace("-", "").replace("[", "").replace("]", "") +"*" +
				 			   " OR cilindros:" + lista.get(i).replace("-", "").replace("[", "").replace("]", "") +"*" +
				 			   " OR litros:" + lista.get(i).replace("-", "").replace("[", "").replace("]", "")+"*"  ;
					 sentencia += ")";
				}
			...
			//query.addSort("num_art_cdo", ORDER.asc);
			query.setQuery(sentencia);
//			System.out.println("Query segundo: "+query );
		...
		{
			//System.out.println("[NuevoportalRamaCDO.- Error: Consultar articulos por parametro en Solr,  Clase: GESTOR-3.qryConsultaGeneralAticulosEnSolr,  Detalle: " + ex.getMessage().toString() +"]");
			Log log=new Log(01,infoCliente.getCve_cdo(),infoCliente.getCve_cliente() ,0, "[Error: Consultar articulos por parametro en Solr,  Clase: GESTOR-3.qryConsultaGeneralAticulosEnSolr,  Detalle: " + ex.getMessage().toString() +"]");
			Cls_Log.insertaLog(log);
			resultadosArt = new SolrDocumentList();	
		}
		return resultadosArt;
	...
	private SolrDocumentList qryConsultaArticulosNuevos(InfoCliente infoCliente)
	{
		...
		catch(Exception ex)
		{
			...
			Log log=new Log(01,infoCliente.getCve_cdo(),infoCliente.getCve_cliente() ,0, "[Error: Consultar articulos por marca en Solr,  Clase: GestorCarritoDeComprasV3.qryConsultaArticulosNuevos,  Detalle: " + ex.getMessage().toString() +"]");
			Cls_Log.insertaLog(log);
	...
	private List<Articulos> llenaClaseArticulos2(SolrDocumentList resultadosArt,  String descArticulo, List<LineasDescuentoFijo> lineasDesFijo, List<CdosTraspasosEmergencia> listaCdosTraspaso, InfoCliente infoCliente, boolean validaCombioNumero, List<String>  lista )
	{
		...
		try
		{
	        ...
	        {   
				if(!resultadosArt.get(i).getFieldValue("vigencia").toString().trim().equals("*"))
				{
		        	...
		        	Articulos articulo= new Articulos();
		        	articulo.setRnk(resultadosArt.get(i).getFieldValue("cdf_rnk").toString().replace("[","").replace("]", ""));
					articulo.setAnio(anios.replace(" ", " - "));
					articulo.setTipo_catalogo(resultadosArt.get(i).getFieldValue("tipo_catalogo").toString());
					articulo.setPrecio_iva(String.valueOf(getTwoDecimals(String.valueOf(Float.parseFloat(preciolista)*1.16))));
		...
		if (lista.size()>0) 
		{
			 List<String> UniqueNumbers= lista.stream().distinct().collect(Collectors.toList());
			 for (String key : UniqueNumbers) { array += "["+key+"],"; }
			 array = array.length()>0 ? array.substring(0,array.length()-1):"";
			 
			 Collections.sort(listaArticulos, new Comparator<Articulos>() {
				    @Override
				    public int compare(Articulos lhs, Articulos rhs) {
				    	if (array.contains(rhs.getNum_art_cdo())) 
				    	{
				    		return 1;
						}
				    	else
			...
			Collections.sort(listaArticulos, new Sortbyroll());	
		}
		
		return listaArticulos;
	}
	  
	public class Sortbyroll implements Comparator<Articulos> {
		  
	    // Method
	    // Used for sorting in ascending order of
	    // roll number
	    public int compare(Articulos a, Articulos b)
	    {
	    	
	    	
	    		if (array.contains(a.getNum_art_cdo())) 
		    	{
		    		a.setOrdenamiento("0");
		    	}
		    	if (array.contains(b.getNum_art_cdo())) 
		    	{
		    		b.setOrdenamiento("0");	
				}	
	    	...
	    	if (!array.contains(a.getNum_art_cdo())) 
	    	{
	    		return Integer.parseInt(a.getOrdenamiento()) - Integer.parseInt(b.getOrdenamiento());	
			}
	    	else
	    	{
	    		return Integer.parseInt(a.getOrdenamiento()) - Integer.parseInt(b.getOrdenamiento());
	...
	private List<String> llenaListaeArticulosDesdeSolrAplicacion(SolrDocumentList resultadosArt, InfoCliente infoCliente)
	{
		...
		catch(Exception ex)
		{
			...
			System.out.println("[NuevoportalRamaCDO.- Error: Llenar clase de Articulos con Solr ,  Clase: GestorCarritoDeComprasV3.llenaListaeArticulosDesdeSolrAplicacion,  Detalle: " + ex.getMessage().toString() +"]");
			Log log=new Log(01,infoCliente.getCve_cdo(),infoCliente.getCve_cliente() ,0, "[Error: Llenar clase de Articulos con Solr,  Clase: GestorCarritoDeComprasV3.llenaListaeArticulosDesdeSolrAplicacion,  Detalle: " + ex.getMessage().toString() +"]");
			Cls_Log.insertaLog(log);
			return listaArticulos;
		}
		return listaArticulos;
	...
	private SolrDocumentList consultaSolar(String desBusqueda) 
	{
		...
		{
			System.out.println("[NuevoportalRamaCDO.- Error: Consultar sugerencias en Solr,  Clase: GestorCarritoDeComprasV3.consultaSolar,  Detalle: " + ex.getMessage().toString() +"]");
			resultadosArt = new SolrDocumentList();
		}
		return resultadosArt;
	}
	...
	{	
		...
		JSONObject ExistenciasArt = null;
		try {
			init();
			ExistenciasArt = consultaExistenciasEnWS2(infoCliente, num_art,cantidadPedida);
			destroy();
		} catch (Exception e) {
			Log log=new Log(0, 0, 0 ,0, "[Error ConsutkaExistenciaArticuloWS,  Clase: GestorCarritoDeComprasV3,  Detalle: " + e +"]");
			Cls_Log.insertaLog(log);
			destroy();
		}
	...
	private JSONObject consultaExistenciasEnWS(InfoCliente infoCliente, String num_art, int cantidad)
	{
		...
		{
			System.out.println("[NuevoportalRamaCDO.- Error: Invocar wsExistencias para consulta de exietncias x articulo ,  Clase: GestorCarritoDeComprasV3.consultaExistenciasEnWS,  Detalle: " + ex.getMessage().toString() +"]");
			Log log=new Log(1,infoCliente.getCve_cdo(),infoCliente.getCve_cliente() ,0, "[Error: Invocar wsExistencias para consulta de exietncias x articulo,  Clase: GestorCarritoDeComprasV3.consultaExistenciasEnWS,  Detalle: " + ex.getMessage().toString() +"]");
			Cls_Log.insertaLog(log);
		}		
	...
	private JSONObject consultaExistenciasEnWS2(InfoCliente infoCliente, String num_art, int cantidad)
	{
		JSONObject rs = null;
		...
		try
		{
			...
			String respuestaJsonString = this.cliente.target(properties.getProperty("URL_WS_EXISTENCIAS") +  "existencias?cve_centro="+infoCliente.getCentro() +"&articulo=" + num_art +"&uname_br="+ uname +"&cantidad=" + cantidad)
	...
	private SolrDocumentList qryConsultaAticuloEnSolr(String descArticulo, InfoCliente infoCliente)
	{
		...
		{
			// System.out.println("[NuevoportalRamaCDO.- Error: Consultar articulos por parametro en Solr,  Clase: GestorCarritoDeComprasV3.qryConsultaAticuloEnSolr,  Detalle: " + ex.getMessage().toString() +"]");
			Log log=new Log(01,infoCliente.getCve_cdo(),infoCliente.getCve_cliente() ,0, "[Error: Consultar articulos por parametro en Solr,  Clase: GestorCarritoDeComprasV3.qryConsultaAticuloEnSolr,  Detalle: " + ex.getMessage().toString() +". Query: "+ query +"]");
			Cls_Log.insertaLog(log);
			resultadosArt = new SolrDocumentList();
		}
