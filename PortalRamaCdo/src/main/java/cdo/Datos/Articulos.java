...
public class Articulos implements Serializable{
	...
	public Articulos() {
		super();
		  ...
		  num_art_anterior = "";
		  vigencia = "";
		  num_art_cdo_sin_guion = "";
		  num_art_prov_sin_guion = "";
		  imagen_bxa = "";
		  imagen_ecommerce = "";
		  intercambio_sin_guion = "";
		  marcaIntercambio = "";
		  nombre_producto = "";
		  tipo_catalogo = "";
		  num_art_marca_propia = "";
		  descripcion_producto = "";
		  varianza_marca_propia = 0.0f;
		  tipo_gasolina = "";
		  caracteristicas = "";
		  cve_venta = "";
		  multiplo_rc = "";
	...
	public Articulos(String num_art_prov, String num_art_cdo, String proveedor, String marca, String descripcion,
			...
			String cve_venta, String multiplo_rc, String rnk) {
		super();
