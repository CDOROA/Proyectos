...
<script type="text/javascript">
	function pintarJSON(json, km, producto, cp){
	...
	function ConsultaClienteKwx() {
		...
		if(km == '' && producto == 0 && cp == ''){
			...
			document.location.href = "${pageContext.request.contextPath}/ServletDondeComprar?operacion=2&km="+km
					+"&Producto=0&cp="+cp+"&lat=19.3474798&longi=-99.11379699999999";
		}else{			
		   if(!cp.match(numbers)){
				...
				fetch('https://maps.googleapis.com/maps/api/geocode/json?address='+cp+'&sensor=false&key=AIzaSyD3pAWctAaHoIRhTERJ1N3lQ_0TZe7tCqY')
				.then(response => response.json())
				.then(json => pintarJSON(json, km, producto, cp))
	...
	<div class="row" style="padding-left: 20px;">
		<div class="col-md-4 col-sm-12">
			...
			<div style="margin-top: 10px" class="input-group">
				...
				<select name="km" id="km" class="form-control" style="width: 110%"> 
