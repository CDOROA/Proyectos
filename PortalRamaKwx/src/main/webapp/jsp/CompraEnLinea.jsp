		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-lg-3 col-md-3 col-sm-12">
						<img class="img-responsive" src="${pageContext.request.contextPath}/img/Encabezados_Online.jpg" alt="" style="display: inline-block; padding: 10px;"></img>					
				</div>
			</div>
		
			<div class="row">
				<div class="col-md-offset-3 col-lg-3 col-md-3 col-sm-12">
					<div class="hovereffect-D">
					<a href="https://www.autorep.mx/search#" target="_blank">
