...
<div id="DivAceites" style="background-image:url('/PortalRamaKwx/image/imgKwx/dondeComprar-encabezado.png');padding-right: 25px;background-position: center;background-repeat: no-repeat;background-size: cover;">
		<div class="row">
