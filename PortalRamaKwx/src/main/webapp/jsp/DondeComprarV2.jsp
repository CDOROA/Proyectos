	...
	<div id="DivAceites"
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class=" col-lg-3 col-md-5 col-sm-12" style="padding-right: 0px;padding-left: 0px;">
					<div class="hovereffect-D">
						<img class="img-responsive" src="${pageContext.request.contextPath}/img/Boton_Acudir.jpg" alt="" style="display: inline-block; padding: 10px; max-width: 285px"></img>
						<div class="overlay"> 
                ...
                <div class="col-lg-3 col-md-5 col-sm-12" style="padding-right: 0px;padding-left: 0px;">
                	<div class="hovereffect-D">
						<img class="img-responsive" src="${pageContext.request.contextPath}/img/Boton_Online.jpg" alt="" style="display: inline-block; padding: 10px; max-width: 285px"></img>
						<div class="overlay"> 
							<!--   <a class="info" href="${pageContext.request.contextPath}/ServletInicio?operacion=2"> -->
				...
				<div class="col-lg-3 col-md-12 col-sm-12" style="padding-right: 0px;padding-left: 0px;">
					<div class="hovereffect-D">
						<img class="img-responsive" src="${pageContext.request.contextPath}/img/Boton_QuieroSer.jpg" alt="" style="display: inline-block; padding: 10px; max-width: 285px"></img>
						<div class="overlay"> 
