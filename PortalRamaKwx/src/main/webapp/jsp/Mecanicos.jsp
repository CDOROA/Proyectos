	 	...
	 	<div class="row">
	 			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="hovereffect ">
						<img class="img-responsive" src="${pageContext.request.contextPath}/img/Busco_2.png" alt="" style="height: 381px;display: inline-block;"></img>
						<div class="overlay"> 
							<!--   <a class="info" href="${pageContext.request.contextPath}/ServletInicio?operacion=2"> -->
							<a class="info" href="${pageContext.request.contextPath}/ServletBuscoMecanico?operacion=1">
							 </a>
	 		...
	 		<div class=" col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="hovereffect ">
						<img class="img-responsive" src="${pageContext.request.contextPath}/img/Soy_2.png" alt="" style="height: 381px;display: inline-block;"></img>
						<div class="overlay"> 
							<!--   <a class="info" href="${pageContext.request.contextPath}/ServletInicio?operacion=2"> -->
							<a class="info" href="${pageContext.request.contextPath}/ServletSoyMecanico?operacion=1">
							 </a>
