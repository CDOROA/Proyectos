...
public class ServletDondeComprar extends HttpServlet {
		...
		try
		{
			...
			switch(operacion)
			{
				case 1:
					...
					listClientes = ObtieneClientesKwx(0);
				...
				case 2:			
					...
					lisArticulos = ObtieneProductosKwx();
					if(km != null) {
						listClientes = ObtieneClientesKwx(producto);
					}
				...
				case 4:
					...
					if(listaCliente != null && listaKM != null) {
						listClientes = ObtieneClientesKwxEspecificos(producto, clientesOrdenados, kmOrden);
						lisArticulos = ObtieneProductosKwx();						
					}					 
					request.setAttribute("latitud2", "");
					request.setAttribute("longitud2", "");
	...
	public List<clientesKwxDto> ObtieneClientesKwx(int articulo)
	{
		List<clientesKwxDto> listClientes= new ArrayList<clientesKwxDto>();
	...
	public List<clientesKwxDto> ObtieneClientesKwxEspecificos(int articulo, String listaClientes, String listaKM)
	{
		List<clientesKwxDto> listClientes= new ArrayList<clientesKwxDto>();
		Connection connBD = null;
		PreparedStatement pstmt = null;
