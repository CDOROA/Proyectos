...
public class RespuestaCancelacionCR  implements java.io.Serializable {
	...
	public String toString() {
		return "RespuestaCancelacionCR [acuse=" + acuse + ", errorDetallado=" + errorDetallado + ", errorGeneral="
				+ errorGeneral + ", operacionExitosa=" + operacionExitosa + ", UUIDS=" + Arrays.toString(UUIDS)
