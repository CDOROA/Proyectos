...
public class ServidorCancelarCFDIS extends HttpServlet 
{
	...
	System.out.println("sdfsdfs: "+listaConsultaFactura);
				...
				{	
					...
					String cuenta = datosTemporales.getCuenta();
					String usuario = datosTemporales.getUsuario();
					String password = datosTemporales.getPassword();
					String uuid = datosTemporales.getUuid();
					...
					System.out.println("Consumir uuid: "+uuid);
					 ...
					 respuestaSW = gestorServicioWeb.ConsumirServicioWeb(cuenta,password,usuario,uuid);
	System.out.println("Respuesta: "+respuestaSW.getRespuestaString());
				...
				String msj="¡Proceso terminado, verifique el status de cada documento!";
				...
				case "Mostrar":
					...
					{		
						...
						{	
							String msj="VERSION INCOMPATIBLE";
							session.setAttribute("msj",msj);
							RequestDispatcher rdIndex = request.getRequestDispatcher("jsp/" + "Cancelacion.jsp");			    	
						    rdIndex.forward(request, response);
						}
