...
import org.datacontract.schemas._2004._07.Emision_Model_DTO_Complementos_CartaPorte.CartaPorte20R;
import org.datacontract.schemas._2004._07.Emision_Model_DTO_Complementos_CartaPorte.CartaPorteMercancias20R;
import org.datacontract.schemas._2004._07.Emision_Model_DTO_Complementos_CartaPorte.CartaPorteMercanciasAutotransporte20R;
import org.datacontract.schemas._2004._07.Emision_Model_DTO_Complementos_CartaPorte.CartaPorteMercanciasAutotransporteIdentificacionVehicular20R;
import org.datacontract.schemas._2004._07.Emision_Model_DTO_Complementos_CartaPorte.CartaPorteMercanciasAutotransporteSeguros20R;
import org.datacontract.schemas._2004._07.Emision_Model_DTO_Complementos_CartaPorte.CartaPorteMercanciasMercancia20R;
import org.datacontract.schemas._2004._07.Emision_Model_DTO_Complementos_CartaPorte.CartaPorteMercanciasMercanciaCantidadTransporta20R;
import org.datacontract.schemas._2004._07.Emision_Model_DTO_Complementos_CartaPorte.CartaPorteMercanciasMercanciaDetalleMercancia20R;
import org.datacontract.schemas._2004._07.Emision_Model_DTO_Complementos_CartaPorte.CartaPorteTiposFigura20R;
import org.datacontract.schemas._2004._07.Emision_Model_DTO_Complementos_CartaPorte.CartaPorteUbicacion20R;
import org.datacontract.schemas._2004._07.Emision_Model_DTO_Complementos_CartaPorte.CartaPorteUbicacionDomicilio20R;
...
//		//System.out.println.println("TIPO CARTA PORTE: "+tipoCartaPorte);
		...
		try
		{
			if (objRespuesta.isRespuesta())
			{
				...
				GenerarCFDIResponse respuesta = new GenerarCFDIResponse();
				////System.out.println.println("referenciaCartaPorte: " + referenciaCartaPorte);
				...
				if (!objRespuesta.isRespuesta())
				{
//					 PrintStream stream	= new PrintStream(//System.out.println);
//					   stream.print(comprobante33r);
//					   
//			            stream.flush();
					log.Insrtalog(cdo, serie, folio, "sellando documento: "+ referenciaCartaPorte );
					  String json = mapper.writeValueAsString(comprobante33r);
//			            //System.out.println.println("dd: "+json);
		...
		{
			objRespuesta.setMsjError("Error en metodo principal sellado. ERROR: "+e.getMessage().toString());
			objRespuesta.setRespuesta(false);
			log.Insrtalog(cdo, serie, folio, "Error en metodo principal sellado. ERROR: "+e.getMessage().toString());
		}
		return objRespuesta;
	}

	private void RecuperaPDF(IService iconexion, Credenciales credenciales2, String cdo) throws RemoteException {
		try {
			...
			////System.out.println.println("UUID: " + uuid);
			respuesta = iconexion.obtenerPDF(credenciales2.getUsuario(),credenciales2.getPassword(), uuid, cdo);
			objRespuesta.setCodigoPDF(respuesta.getPDF());
		}
		catch (Exception e) {
			log.Insrtalog(cdo, serie, folio, "Error al  recuperar el PDF: " + e);
			//System.out.println.println("Error al  recuperar el PDF: " + e);
		}
	}
	public static String deserializeObjectToString(final Object object) {
        return GSON.toJson(object);
    }
	private void imprimirMensajesDeRespuestaCR(String cdo,RespuestaOperacionCR respuesta) 
	{
		////System.out.println.println("Codigo de Operacion Existosa en ImprimiMensajeRespuesta: "+respuesta.getOperacionExitosa());
		/*//System.out.println.println("Codigo de Error General: "+respuesta.getErrorGeneral());
		//System.out.println.println("Codigo de Error Detallado: "+respuesta.getErrorDetallado());
		//System.out.println.println("Codigo de Folio Generado: "+respuesta.getFolioGenerado());
		//System.out.println.println("Codigo de Folio Generado: "+respuesta.getFolioGenerado());
		//System.out.println.println("Codigo de confrimacion: "+respuesta.getCodigoConfirmacion());
		//System.out.println.println("Codigo de Error General: "+respuesta.getErrorGeneral());
		//System.out.println.println("Codigo de Error Detallado: "+respuesta.getErrorDetallado());
		*/
		...
		{	
			objRespuesta.setCodigoXML(convertirBaseXml(respuesta.getXML()));
			objRespuesta.setRespuesta(respuesta.getOperacionExitosa());
			objRespuesta.setCodigoCBB(respuesta.getCBB());	
			
			////System.out.println.println("Codigo de CBB: "+respuesta.getCBB().length());
			////System.out.println.println("Codigo de Addenda: "+respuesta.getAddenda());
		     //System.out.println.println("Codigo de PDF: "+respuesta.getPDF());
		    //System.out.println.println("Codigo de XML: "+respuesta.getXML());
		}
		else
		{
			objRespuesta.setConceptos(null);
			objRespuesta.setRespuesta(respuesta.getOperacionExitosa());
			objRespuesta.setMsjError("ERROR GENERAL: "+respuesta.getErrorGeneral().toString()+". DETALLADO: "+ respuesta.getErrorDetallado().toString());
			System.out.println("ERROR GENERAL: "+respuesta.getErrorGeneral()+". DETALLADO: "+ respuesta.getErrorDetallado());
//			log.Insrtalog(cdo, serie, folio, "ERROR GENERAL:" +respuesta.getErrorGeneral().toString() + ". DETALLADO: "+ respuesta.getErrorDetallado().toString() );
		}
	}
	
	private void recuperaCartaPorte(IService iconexion, Credenciales cre, String referenciaCartaPorte2, String cdo ) 
	{
		 try {
			 System.out.println("usuario: "+cre.getUsuario());
			System.out.println("password: "+cre.getPassword());
			System.out.println("referencia: "+referenciaCartaPorte2);
			RespuestaOperacionCR respuesta = iconexion.obtenerXMLPorReferencia(cre.getUsuario(),cre.getPassword(), referenciaCartaPorte2);
//			GenerarCFDIResponse respuesta = iconexion.xml
//			RespuestaOperacionCR respuesta = iconexion.obtenerXMLPorReferencia(credenciales, referenciaCartaPorte);
			////System.out.println.println(respuesta.getXML());
			imprimirMensajesDeRespuestaCR(cdo, respuesta);
			System.out.println("respuesta de recuperaCartaPorte: " + respuesta.getOperacionExitosa());
			if (respuesta.getOperacionExitosa())
			{
//				//System.out.println.println("Autorizado recuperrar pdf");
				RecuperaPDF(iconexion, cdo,cre);
			
			}

		} catch (RemoteException e) {
			//System.out.println.println("Error al recuperar la carta porte: " + e);
	...
	private void RecuperaPDF(IService iconexion,String cdo, Credenciales c) throws RemoteException 
	{
		try {
			log.Insrtalog(cdo, serie, folio, "Recuperando codigo del PDF.");
			RespuestaOperacionCR respuesta;
			...
			respuesta = iconexion.obtenerPDF(c.getUsuario(),c.getPassword(), uuid, cdo);
			objRespuesta.setCodigoPDF(respuesta.getPDF());
		}
		catch (Exception e) {
//			log.Insrtalog(cdo, serie, folio, "Error al  recuperar el PDF: " + e);
	        ...
	        try
	        {
	            ...
	            if (rs != null) 
	            {
	            	while(rs.next()) {
		            	...
		            	////System.out.println.println("tipo: " + tipo);	
	            	}	            	
	            }
	        ...
	        try
	        {
	         ...
	         if(tipoCartaPorte.equals("C")) {
	        	 querys = inicializacionQrys(querys, ListaQuerys, cdo, 3,uname_br,trayecto);
		            pstmt = connBD.prepareStatement("{call " + cdo.toUpperCase() + ".usp_EXECUTE_QUERY_CP(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");
		            rs = EjecutaQuerysBD.EjecutarQuery(querys[0], querys[1], querys[2], querys[3], querys[4], querys[5], querys[6], querys[7], querys[8], querys[9], querys[10], querys[11], querys[12], querys[13], querys[14], querys[15], querys[16], querys[17], querys[18], querys[19], querys[20], querys[21], querys[22], querys[23], querys[24], cdo, pstmt, connBD);		            	            
		            Cls_Querys.ImprimeQuerysConsola(querys, false, "/*Recuperando informacion de BD .CDO.*/");
	         }else {
	        	 querys = inicializacionQrys(querys, ListaQuerys, cdo, 6,uname_br,trayecto);
		            pstmt = connBD.prepareStatement("{call " + cdo.toUpperCase() + ".usp_EXECUTE_QUERY_CP(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");
		            rs = EjecutaQuerysBD.EjecutarQuery(querys[0], querys[1], querys[2], querys[3], querys[4], querys[5], querys[6], querys[7], querys[8], querys[9], querys[10], querys[11], querys[12], querys[13], querys[14], querys[15], querys[16], querys[17], querys[18], querys[19], querys[20], querys[21], querys[22], querys[23], querys[24], cdo, pstmt, connBD);		            	            
		            Cls_Querys.ImprimeQuerysConsola(querys, false, "/*Recuperando informacion de BD .RCS.*/");
	         }
	            
	            if (rs != null) 
	            {
	            	////System.out.println.println("Entra al llenado. ");
	            	llenarInfoSellado(cdo, rs);
				}
	            /*//System.out.println.println("mercancia boolean: "+ merc);
	            //System.out.println.println("conceptos boolean: "+ conc);
	            //System.out.println.println("ubicaciones boolean: "+ ubi);
	            //System.out.println.println("encabezado boolean: "+ enc);*/
		...
		try
		{
			while (rs.next()) 
			{
				...
				if (tipo.equals("1mercancia"))
					...
					{
					//	//System.out.println.println("MERCANCIA");
				...
				if (tipo.equals("2conceptos")) {
					...
					//	//System.out.println.println("CONCEPTOS");
						conc = true;
						idConceptos++;}
					if (tipo.equals("3ubicaciones")) {
					//	//System.out.println.println("UBICACIOMEs");
					...
					{
					//	//System.out.println.println("ENCABEZADO");
	...
	private void validarRegistros(boolean merc, boolean conc, boolean ubi, boolean enc) 
	{
		...
		for (int i = 0; i < arrayRepsuesta.length; i++) 
		{
			if (!arrayRepsuesta[i])
			{
				...
				//System.out.println.println("No se encontraron registros en la seccion: "+descripcion[i]);
			}
		}
	}
...
//			comprobante33r.setLugarExpedicion(null);
			comprobante33r.setLugarExpedicion(exp_codPostal);
			////System.out.println.println("Lugar Expedicion: "+comprobante33r.getLugarExpedicion());
			...
			comprobante33r.setTipoDeComprobante("T");
			/** DATOS EN CEROS **/
     		//comprobante33r.setSubTotal(new BigDecimal(valor("subtotal", rs)));
	
			//comprobante33r.setTotal(new BigDecimal(valor("total", rs)));
			BigDecimal formatDecim = new BigDecimal("0");
			formatDecim = formatDecim.add(new BigDecimal("0"));
			comprobante33r.setSubTotal(formatDecim);
			
			comprobante33r.setTotal(formatDecim);
...
//			comprobante33r.setSerie(valor("serie",rs));
			...
			/* Se omite */
//			comprobante33r.setFecha(null);
			comprobante33r.setFecha(obtenerFecha(valor("fecha", rs)));
//			//System.out.println.println(comprobante33r.getFecha());
	...
	{
//		//System.out.println.println("FECHA: "+parametroFecha);
		...
		try 
		{
			 ...
			 parametroFecha = String.valueOf(formatoFecha.parse(parametroFecha));
//			 //System.out.println.println(parametroFecha);
//			 //System.out.println.println(fecha.getTime());
//			 //System.out.println.println(fecha.getInstance());
		}
	...
	private ConceptoR[] llenarArrayConceptos(ConceptoR[] conceptos) 
	{
		...
		{
//			conceptos[i] = new ConceptoR(ACuentaTerceros, cantidad, claveProdServ, claveUnidad, cuentaPredial, descripcion, descuento, importe, impuestos, informacionAduanera, noIdentificacion, objetoImp, parte, unidad, valorUnitario)
			conceptos[i] = new ConceptoR(
					lstConceptos.get(i).getACuentaTerceros(),
...
//			//System.out.println.println(conceptos[i]);
	...
	private void  obtenerConceptos(ResultSet rs, int idConceptos) 
	{
		try
		{
			 ...
			 */
//	ConceptoR(ACuentaTerceros, cantidad, claveProdServ, claveUnidad, cuentaPredial, descripcion, descuento, importe, impuestos, informacionAduanera, noIdentificacion, objetoImp, parte, unidad, valorUnitario)
//  ConceptoR(                 cantidad, claveProdServ, claveUnidad, cuentaPredial, descripcion, descuento, importe, impuestos, informacionAduanera, instEducativas, noIdentificacion, partes, porCuentadeTerceros, unidad, valorUnitario, ventaVehiculos)
			BigDecimal formatDecim = new BigDecimal("0.0");
			BigDecimal formatDecim2 = new BigDecimal("0.0");
			BigDecimal formatDecim3 = new BigDecimal("0.0");
			formatDecim = formatDecim.add(new BigDecimal(valor("CantSurtida", rs)));
			formatDecim2 = formatDecim2.add(new BigDecimal("0"));
			formatDecim3 = formatDecim3.add(new BigDecimal("0"));
			lstConceptos.add(new ConceptoR(
					null, //acuentaterceros
					formatDecim, //canridad
					valor("claveProdServ", rs).equals("78102200") ? "44121503" : valor("claveProdServ", rs),//claveprodserv
					valor("ClaveUnidad", rs),//claveunidad
					null,//cuentapredial
					valor("descripcion", rs),//descripcion
					null,//descuento
					formatDecim3,//importe
					null,//impuestos
					// ObtenerImpuestos(rs),
					null,//infoaduanera
//					null,//insteducativas
					valor("numArt", rs),//noidentificacion
					"01", //objImp
					null,//parte
//					null,//porcuentaterceros
					valor("ClaveUnidad", rs),//unidad
					formatDecim2//valoruni
//					null //vehiculos
					));
			Conceptos c = new Conceptos();
			c.setAplicaicon(valor("aplicacion", rs));
			c.setC_ClaveProdServ(valor("claveProdServ", rs).equals("78102200") ?valor("claveProdServ", rs)  : "44121503");
			...
			// //System.out.println.println("c.setC_ClaveProdServ: " + c.getC_ClaveProdServ());
	...
	private EmisorR obtenerEmisor(ResultSet rs) 
	{
		try
		{
			emisor.setRfc(valor("rfc", rs));
			//emisor.setNombre("CENTRO DE DISTRIBUCION ORIENTE"); 
			emisor.setNombre(valor("nombre_fiscal", rs));
			//emisor.setRfc("CDO0509296I9");
	...
	private CartaPorte20R obtenerCartaPorte(ResultSet rs) 
	{
		...
		{
			//System.out.println.println("Error al obtener ubicaciones. ERROR: "+e);
	...
	
	{
		...
		cartaMercancias.setUnidadPeso("KGM");
		  ...
		  // //System.out.println.println("tPeso Bruto Total: " + pesoBrutoTotal);
		 //  //System.out.println.println("tPeso Bruto Total big decimal: " +new BigDecimal(pesoBrutoTotal));
...
//				merc.setDetalleMercancia(lstMercancias.get(i).getDetalleMercancia());
			...
			//	//System.out.println.println("Mercancias.BienesTransp: "+lstMercancias.get(i).getBienesTransp()  + ". Mercancia.tDescripcion: "+  lstMercancias.get(i).getDescripcion() + ". MercanciasMaterialPeligroso: " + lstMercancias.get(i).getMaterialPeligroso() + " - " + "Mercancias.CveMaterialPeligroso: " + lstMercancias.get(i).getCveMaterialPeligroso() );
	...
	private CartaPorteMercanciasMercancia20R obtenerCartaMercancia(String destino, String origen, ResultSet rs, int idMercancias) 
	{
		...
		try
		{
			...
			cartaMercancia.setBienesTransp(valor("c_ClaveProdServ_mercancia", rs).equals("78102200") ? "44121503" :valor("c_ClaveProdServ_mercancia", rs));
			BigDecimal formatDecim = new BigDecimal("0.0");
			formatDecim = formatDecim.add(new BigDecimal(valor("cantidad_mercancia", rs)));
			BigDecimal formatDecim3 = new BigDecimal("0.0");
			formatDecim3 = formatDecim3.add(new BigDecimal(valor("peso_bruto_mercancia", rs)));
            cartaMercancia.setCantidad(formatDecim);
			...
			CartaPorteMercanciasMercanciaCantidadTransporta20R[] mercanciaTransporta = new CartaPorteMercanciasMercanciaCantidadTransporta20R[1];
			mercanciaTransporta[0] = new CartaPorteMercanciasMercanciaCantidadTransporta20R(formatDecim, null, valor("idDestino_mercancia", rs), valor("idOrigen_mercancia", rs));
			
			cartaMercancia.setCantidadTransporta(mercanciaTransporta);
			/*
...
//			cartaMercancia.setPesoEnKg(new BigDecimal(valor("peso_bruto_mercancia", rs)));
			cartaMercancia.setPesoEnKg(formatDecim3);
			////System.out.println.println("Peso en Kg: "+cartaMercancia.getPesoEnKg());
			//cartaMercancia.setPesoEnKg(new BigDecimal(pesoBrutoMercancia));
			cartaMercancia.setUnidad("KGM");
			BigDecimal formatDecim2 = new BigDecimal("0.0");
			formatDecim2 = formatDecim2.add(new BigDecimal(valorMercancia));
			cartaMercancia.setValorMercancia(formatDecim2);
			
			 String MaterialPeligroso = valor("es_material_Peligroso", rs).trim();
			// //System.out.println.println("Materia peligroso: " + MaterialPeligroso);
			 ...
			 if(!MaterialPeligroso.equalsIgnoreCase("0"))
			{
				...
				/*//System.out.println.println("Obtiene Material Peligroso:1 " + cartaMercancia.getMaterialPeligroso());
				//System.out.println.println("Obtiene CveMaterialPeligroso:1 "+cartaMercancia.getCveMaterialPeligroso());
				//System.out.println.println("Obtiene el embalaje:1  "+cartaMercancia.getEmbalaje());*/
			}/*else {
				cartaMercancia.setMaterialPeligroso(null);	
				cartaMercancia.setCveMaterialPeligroso(null);
				cartaMercancia.setEmbalaje(null);
				//System.out.println.println("Obtiene Material Peligroso:2 " + cartaMercancia.getMaterialPeligroso());
				//System.out.println.println("Obtiene CveMaterialPeligroso:2 "+cartaMercancia.getCveMaterialPeligroso());
				//System.out.println.println("Obtiene el embalaje:2  "+cartaMercancia.getEmbalaje());
			}*/
			

			
			pesoBrutoTotal = pesoBrutoTotal.add(new BigDecimal(valor("peso_bruto_mercancia", rs)));
            ////System.out.println.println("Peso Mercancia: " + pesoBrutoTotal);
		}
		catch (Exception e) 
		{
			//System.out.println.println("Error al llenar carta mercancia. ERROR: "+e);
	...
	private CartaPorteMercanciasMercanciaDetalleMercancia20R GeneraDetalleMercancia(ResultSet rs) {
		...
		try
		{
			...
			//System.out.println.println("Error al llenar Detalle Mercancia. ERROR: "+e);
	...
	private CartaPorteMercanciasAutotransporteSeguros20R obtenerSerugo(ResultSet rs) {
		...
		try {
			...
			////System.out.println.println("Nombre de la aseguradora: "+seguro.getAseguraRespCivil());
			////System.out.println.println("Numero de poliza: "+seguro.getPolizaRespCivil());
			...
			////System.out.println.println("material Peligroso 100: " + materialPeligro);
			...
			//}
				...
				//seguro.setAseguraMedAmbiente("Olimpo S.A. de C.V.");
				////System.out.println.println("AseguraMedAmbiente: " + seguro.getAseguraMedAmbiente());
				seguro.setPolizaCarga("368549");
			
				seguro.setPolizaRespCivil("06292021");
				
				seguro.setPrimaSeguro(new BigDecimal("1200.0"));
...
//					null,
		...
		{
			//System.out.println.println("Error al Obtener figuraTransporte: " + ex);	
	...
	private void obtenerUbicaciones(ResultSet rs, int idUbicaciones) {
		...
		try {
			...
			if (valor("orden", rs).equalsIgnoreCase("0")) {
				/* Oirgen */
				////System.out.println.println("Entra a orden igual a 0");
...
//				ubicacion20r.setDistanciaRecorrida(new BigDecimal(valor("distanciaRecorrida", rs)));
				...
				/* Destino */
				////System.out.println.println("Entra a orden diferente a 0");
				ubicacion20r.setDistanciaRecorrida(new BigDecimal(valor("distanciaRecorrida", rs)));
				ubicacion20r.setDomicilio(obtenerDomicilio(rs));
				ubicacion20r.setFechaHoraSalidaLlegada(valor("fecha_aprox_llegada", rs));
			...
			////System.out.println.println("totalDistanciaRecorrida: " + totalDistanciaRecorrida);
		} catch (Exception e) {
			objRespuesta.setMsjError("Error al obtener ubicaciones. ERROR: " + e.getMessage());
			objRespuesta.setRespuesta(false);
		}
	...
	private ReceptorR obtenerReceptor(ResultSet rs) 
	{
		try
		{
//			//System.out.println.println("RFC: "+valor("rcodigo_postal", rs));
		receptor.setDomicilioFiscalReceptor("09209");
...
//	}
	...
	private void imprimirMensajesDeRespuesta(String cdo,GenerarCFDIResponse respuesta) 
	{
		...
		System.out.println("Codigo de Error General: "+respuesta.getOperacionExitosa());
		System.out.println("Codigo de Error Detallado: "+respuesta.getPDF());
		
		
		System.out.println("INFORMACION. RESPUESTA: "+respuesta.getOperacionExitosa().toString()+ ". ERRORES: "+respuesta.getErrores().length);
		if (respuesta.getErrores().length>0) 
		{
			ErroresCFDI[] errores = respuesta.getErrores();
			for (int i = 0; i < errores.length; i++) 
			{
				System.out.println("ERROR "+i+": "+errores[i].getErrorGeneral()+". ERROR DETALLADO: "+errores[i].getErrorDetallado());
			}
		}
		if (respuesta.getOperacionExitosa()) 
		{	
			...
			////System.out.println.println("Codigo de Addenda: "+respuesta.getAddenda());
		     ////System.out.println.println("Codigo de PDF: "+respuesta.getPDF());
		    ////System.out.println.println("Codigo de XML: "+respuesta.getXML().length());
		}
		else
		{
			objRespuesta.setConceptos(null);
			objRespuesta.setRespuesta(respuesta.getOperacionExitosa());
			objRespuesta.setMsjError("ERROR GENERAL: "+respuesta.getErrores().toString());
	...
	public String convertirBaseXml(String base64) {
		byte[] base642 = Base64.getDecoder().decode(base64);
		String xml = new String(base642);
		return xml;
	}
}
