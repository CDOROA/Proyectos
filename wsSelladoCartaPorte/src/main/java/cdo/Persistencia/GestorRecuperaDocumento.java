...
import org.datacontract.schemas._2004._07.Emision_Model_DTO_Nomina_Mailer.*;
...
//		obtenerInformacionParaSellado(cdo,uname_br,trayecto,listaQuerys);
		try
		{
				System.out.println("RecuperaDocumento.");
				ServiceLocator conector=new ServiceLocator();
				IService iconexion = conector.getBasicHttpBinding_IService();
				System.out.println("conexion: "+iconexion);
//				iconexion.
				try
				{
					
					respuesta = iconexion.obtenerPDF("HQLOPGKZ-CDFC", "YDNMV4LON", folioCfdi,"");
				}
				catch (Exception e) 
				{
