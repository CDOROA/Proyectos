...
<html>
	<head>
		...
		<title>Relaciones Encuestas</title>
	 					...
	 					<td>
	 						<div class="panel panel-primary" >
								<div class="panel-heading">
									 <div class="panel-title" align="left"> <label class="EG_lbTituloEncabezado">Relaciones Encuestas</label></div>
								</div>
										...
										<tr>
											<td colspan="2" align="center">
												<div>
													...
													<input type="hidden" name="proceso_web" id="idIndex" value="160" >
