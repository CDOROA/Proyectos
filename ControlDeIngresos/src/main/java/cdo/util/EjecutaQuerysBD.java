...
public class EjecutaQuerysBD {
	...
	{		
		...
		System.out.println(qry13);
		System.out.println(qry14);
		System.out.println(qry15);
		System.out.println(qry16);
		System.out.println(qry17);
		System.out.println(qry18);
		System.out.println(qry19);
		System.out.println(qry20);
		System.out.println(qry21);
		System.out.println(qry22);
		System.out.println(qry23);
		System.out.println(qry24);
		System.out.println(qry25);
		ResultSet rs = null;
		try
		{
