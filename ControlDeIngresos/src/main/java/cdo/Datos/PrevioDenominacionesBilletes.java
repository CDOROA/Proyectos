...
public class PrevioDenominacionesBilletes  implements Serializable
{
	...
	private  String fajillas100;
	private  String fajillas50;
	private  String fajillas25;
	 
	 
	public PrevioDenominacionesBilletes() {
		super();
	}

	public PrevioDenominacionesBilletes(int id_denominacion, String denominacion, String tipo_denominacion) {
		super();
