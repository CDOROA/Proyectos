...
public class Usuario implements Serializable {
	...
	public Usuario(String cve_usuario, String nombre, int cve_departamento, String departamento,
			int nivel_usuario, int dato_numerico, String dato_alfanumerico, String uname, String uname_nombre,
	...
	public String toString() {
		return "InformacionUsuario [cve_usuario=" + cve_usuario + ", nombre=" + nombre + ", cve_departamento="
				+ cve_departamento + ", departamento=" + departamento + ", nivel_usuario=" + nivel_usuario
				+ ", dato_numerico=" + dato_numerico + ", dato_alfanumerico=" + dato_alfanumerico + ", uname=" + uname
				+ ", uname_nombre=" + uname_nombre + ", uname_br=" + uname_br + ", uname_br_nombre=" + uname_br_nombre
				+ "]";
	}
